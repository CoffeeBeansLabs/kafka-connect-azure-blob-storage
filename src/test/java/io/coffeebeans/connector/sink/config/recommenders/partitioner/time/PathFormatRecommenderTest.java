...
/**
 * Unit tests for PathFormatRecommender.
 */
public class PathFormatRecommenderTest {
    ...
    public void isVisibleShouldReturnTrue() {
        ...
        Assertions.assertTrue(new PathFormatRecommender().visible(
                AzureBlobSinkConfig.PARTITION_STRATEGY_TIME_PATH_FORMAT_CONF_KEY, parsedConfig));
    }
    ...
    public void isVisibleShouldReturnFalse() {
        ...
        Assertions.assertFalse(new PathFormatRecommender().visible(
                AzureBlobSinkConfig.PARTITION_STRATEGY_TIME_PATH_FORMAT_CONF_KEY, parsedConfig));
    }
}
