...
public class ContainerNameValidatorTest {
    ...
    public void test_nullContainerName() {
        Assertions.assertThrowsExactly(ConfigException.class, () -> {
            new ContainerNameValidator().ensureValid(
                    AzureBlobSinkConfig.AZURE_BLOB_CONTAINER_NAME_CONF, CONTAINER_NAME_NULL
            );
    ...
    public void test_emptyContainerName() {
        Assertions.assertThrowsExactly(ConfigException.class, () -> {
            new ContainerNameValidator().ensureValid(
                    AzureBlobSinkConfig.AZURE_BLOB_CONTAINER_NAME_CONF, CONTAINER_NAME_EMPTY
            );
        }, "Invalid container name: ");
    }
    ...
    public void test_blankContainerName() {
        Assertions.assertThrowsExactly(ConfigException.class, () -> {
            new ContainerNameValidator().ensureValid(
                    AzureBlobSinkConfig.AZURE_BLOB_CONTAINER_NAME_CONF, CONTAINER_NAME_BLANK
            );
        }, "Invalid container name: ");
    }
    ...
    public void test_validContainerName() {
        Assertions.assertDoesNotThrow(() -> {
            new ContainerNameValidator().ensureValid(
                    AzureBlobSinkConfig.AZURE_BLOB_CONTAINER_NAME_CONF, CONTAINER_NAME_VALID
            );
        });
    }
}
