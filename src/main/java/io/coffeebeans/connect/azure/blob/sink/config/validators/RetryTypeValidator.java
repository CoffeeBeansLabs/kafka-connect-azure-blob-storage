...
public class RetryTypeValidator implements ConfigDef.Validator, ConfigDef.Recommender {
    ...
    private static final List<Object> RETRY_TYPES;
    ...
    public void ensureValid(String name, Object value) {
        ...
        for (Object type : RETRY_TYPES) {
            String castedType = (String) type;
            if (castedType.equalsIgnoreCase(configuredPolicyType)) {
                return;
            }
        }
